...
#' @export
#'
calculate_GR_value <- function(rel_viability, corrected_readout, day0_readout, untrt_readout, ndigit_rounding, duration, ref_div_time, cl_name) {
  if (any(is.na(day0_readout))) {
    ...
    GRvalue <- calculate_time_dep_GR_value(corrected_readout, day0_readout, untrt_readout, ndigit_rounding)
  }
  GRvalue
}
...
#' @export
#'
calculate_time_dep_GR_value <- function(trt_readout, day0_readout, untrt_readout, ndigit_rounding) {
