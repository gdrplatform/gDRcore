...
normalize_SE <- function(df_raw_data,
    ...
    normSE <- gDRcore::create_SE(df_raw_data, data_type = "treated", discard_keys = discard_keys)
    SummarizedExperiment::assayNames(normSE) <- "Normalized"
    ctrlSE <- gDRcore::create_SE(df_raw_data, data_type = "untreated", discard_keys = discard_keys)
