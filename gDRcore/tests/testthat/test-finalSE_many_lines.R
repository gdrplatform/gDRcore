original <- readRDS(system.file("testdata", "finalSE_many_lines.RDS", package = "gDRtestData"))

df_layout <- merge(gDRtestData::create_synthetic_cell_lines(), gDRtestData::create_synthetic_drugs()[1:40,], by = NULL)
...
test_synthetic_data(original, finalSE, "finalSE_many_lines.RDS")
