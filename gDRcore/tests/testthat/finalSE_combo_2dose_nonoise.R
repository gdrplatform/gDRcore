context("Test finalSE_combo_2dose_nonoise")
original <- readRDS(system.file("testdata", "finalSE_combo_2dose_nonoise.RDS", package = "gDRtestData"))
...
test_that("Original finalSE_combo_2dose_nonoise data and recreated data are identical", {
