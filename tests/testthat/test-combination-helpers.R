test_that("map_ids_to_fits works as expected", {
  ...
  exp1 <- predict_efficacy_from_conc(pred[1], fit1$x_inf, fit1$x_0, fit1$ec50, fit1$h)
  exp2 <- predict_efficacy_from_conc(pred[2], fit1$x_inf, fit1$x_0, fit1$ec50, fit1$h)
  exp3 <- predict_efficacy_from_conc(pred[3], fit2$x_inf, fit2$x_0, fit2$ec50, fit2$h)
